...
static const NSString* maze1String = @"*E*********  *    b**  O   *******     **     *  ** 1   * *** *  *   ****  *  ***a   *   ***S*******";
static const int maze1Width = 10;
static const NSString* maze2String = @"*****S***************           *a     **  *******  *****  **R *     *      *  *****  *  ****   *  **     *     *      **     O     ****   ** ********  *  *   **       *   *  *   **   **  *   *  *   **   *b  *          **   ******1******O***       *   *      ** ***** *   *  ******     * *** *      **   * * *   ****** **   *****        * **           *  *** ***********  *      **a          O      *****************E***";
static const int maze2Width = 20;
static const NSString* maze3String = @"**************************   *   *   *           ** * * * * * * * ******* **1* *b*   *   * *       ** * *********** * ******** *             *      1** ********************* ** *                *    **   **** ******* * * ***** * *            * * *  E* * *** * ******** *   *** *   * * *      * ****a** ***O* * * ** *  1   * ** *   * *   ** **** *** ** * *** *   **    * *   ** * *   * ******* * * **** * * * * *   *a* * *   ** *   * * * * * * * *** ** ***** * * * * *     * **      O* * * * * * * * ** ***** * * * * * * * * **     * *   *   * * *   ** * * * ********* * ****** * * *                 ********************S*****";
