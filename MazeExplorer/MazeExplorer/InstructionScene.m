...
-(id)initWithSize:(CGSize)size {
    if (self = [super initWithSize:size]) {
        ...
        DSMultilineLabelNode *instructions = [[DSMultilineLabelNode alloc] init];
        ...
        instructions.paragraphWidth = self.frame.size.width - 100;
        instructions.fontSize = 25;
        instructions.position = CGPointMake(CGRectGetMidX(self.frame),CGRectGetMaxY(self.frame)-400);
    ...
    checkButton.position = CGPointMake(CGRectGetMidX(self.frame),CGRectGetMinY(self.frame)+150);
